    ...
    internal class Usuarios
    {
        ...
        public DataTable Log_Usu(string L_Usu, string P_Usu)
        {
            ...
            try
            {
                ...
                // el comando es un elemento que almacena en este caso elnombre del procedimiento almacenado y la referencia a la conexion
                ...
                // abrimos la conexion
                sqlCon.Open();
                resultado = comando.ExecuteReader(); // almacenamos elresulatdo en la variable
